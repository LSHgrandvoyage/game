...
void Game::initializeResources() {
    ResourceManager::getInstance().loadTexture("spaceship", "data/textures/spaceship.png");
    ResourceManager::getInstance().loadTexture("obstacle", "data/textures/littleplanet.png");
    ResourceManager::getInstance().loadTexture("background", "data/textures/spacebackground.png");
    ResourceManager::getInstance().loadTexture("explode", "data/textures/explode.png");
    ResourceManager::getInstance().loadFont("main", "data/fonts/arial.ttf");

    AudioManager::getInstance().loadMusic("bgm", "data/audio/bgm.mp3");
    AudioManager::getInstance().loadSound("boom", "data/audio/boomsound.mp3");
    AudioManager::getInstance().loadSound("levelup", "data/audio/levelup.mp3");
    AudioManager::getInstance().playMusic("bgm", true);
}
